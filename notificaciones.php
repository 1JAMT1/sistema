...
@media (max-width: 600px) {
    .cabecera {
        ...
        padding: 8px;  /* Reducir el padding de la cabecera */
        font-size: 14px;  /* Reducir el tamaño de la fuente */
        flex-direction: column; /* Asegura que los elementos se apilen verticalmente */
    }

    .uno, .search {
        flex: none;  /* No ocupa el 50% del espacio */
        padding: 5px;
        margin: 5px;  /* Reducir el padding interno */
    }

    .search {
        margin-top: 60px; /* Espacio entre .uno y .search */
    }
}
...
<body>
    ...
    <aside id="aside">
            ...
            <div class="conten">
                ...
                <div class="dere">
                    ...
                    <button id="btn_abrir" style="background-color: #38DB96; border-radius: 5px; padding: 5px; border: none;margin-right: 20px;color: #ffffff; ">Mandamiento</button>
  
                    <dialog id=modal>
                    <canvas id="pdf-canvas"></canvas>   
                    <center>                    <div id=modal1></div>
                    </center>
    ...
    const openModalBtn = document.getElementById('btn_abrir');
    const closeModalBtn = document.getElementById('btn_cerrar');
    const pdfContainer = document.getElementById('modal1');

    const url = 'doc/doc1.pdf';
    ...
    function renderPDF() {
        pdfjsLib.getDocument(url).promise.then(function (pdf) {
            pdfContainer.innerHTML = ''; // Limpiar contenedor antes de renderizar
