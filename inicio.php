        ...
        <section class="search">
            <div class="buscador">
                ...
                <button type="button" class="btn btn-light">    Buscar    </button>
                  <svg id="lupa" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
